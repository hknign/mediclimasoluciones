"""
Django settings for ainilebust project.
...
SECRET_KEY = 'django-insecure-c(fim+0ke#zegmtogjgdz$2u3ms(751ci1=8w^6b5^73kg2^gx'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'appWeb.context_processors.cart_context',
...
WSGI_APPLICATION = 'ainilebust.wsgi.application'
